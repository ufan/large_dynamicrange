...
The figures are both higher than the desired value, however the supply voltage can be adjusted to get the optimal result.
% The composition of dynode4 and dynode7 can also get the desired value by increasing the supply voltage, however this also increases the risk of hv break down in space.
