...
To facilitate selecting the appropriate dynode stages for readout, an estimation of the mean number of photon electrons(PEs) generated by one MIP is carried out.
...
Based on the PEs calculation, the best-suited dynode composition is dynode5$+$dynode8, which corresponds to a MIP response of \SI{450}{\femto\coulomb} and gain ratio of 65.
