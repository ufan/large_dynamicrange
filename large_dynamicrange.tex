...
And tests with cosmic ray and high energy ion beam have been carried out to verify the performance of the readout unit.
...
\begin{table}\footnotesize
	...
	\begin{tabulary}{85mm}{CCCCCCC}
		\toprule
		& $\sigma_{noise}$ & $MPV$ & $\sigma_{mpv}$ & $dy58$ & $\eta_{min}$ & $\eta_{max}$\\
...
\begin{table}\footnotesize
	...
	\begin{tabulary}{80mm}{CCCC}
		\toprule
		& $\sigma_{noise}$ & $Mean_{Ar}$ & $\sigma_{Ar}$\\
		\midrule
