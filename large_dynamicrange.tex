...
The relative resolution of the PSD detector module for $^{40}Ar$ is calculated and it's about \SI{4.5}{\percent} and \SI{4.2}{\percent} for the left and right side respectively.
...
Combining the results from the cosmic ray test (see Table~\ref{tab:mip}), the light yield of Ar in the bar can be calculated as ${\mu_{Ar}\cdot dy58} / {\mu_{mpv}}$, which gives \SI{220}{MIPs} and \SI{216}{MIPs} for the left and right side respectively.
...
Taking into account other effects such as the traverse length and the light attenuation, the largest signal of Ca in Dy5 is estimated to be \SI{1166}{MIPs} and \SI{1136}{MIPs}.
