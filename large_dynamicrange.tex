...
Tests on a prototype detector module using cosmic ray and relativistic ion beam show that the readout unit could easily cover the dynamic range from 0.1 MIPs to 1400 MIPs, which is needed by PSD for measuring particles from electron to heavy ions with $Z\leq 20$ simutaneously. 
