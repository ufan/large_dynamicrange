...
To select the appropriate dynode stages for readout, an estimation of the mean number of photon electrons (PE) generated by one MIP in the center of the bar is carried out.
...
The number of photon electrons is deduced as follows:
\begin{align}
...
Based on Eq.~\ref{eq:pes} and  Eq.~\ref{eq:dygain}, the 8th dynode ( Dy8 ) and the 5th dynode ( Dy5 )of R4443 are selected to cover lower and higher part of the dynamic range respectively.
...
Combing Dy8 and Dy5, the readout unit of PSD achieves the demanded dynamic range of 4 orders of magnitude, and also provides a cross calibration between these two dynodes.
