...
Based on the fitting result, the light attenuation ratio at various positions can be calculated(see Tab.~\ref{tab:summary}) and they are all within the estimated limit described in Sec.~\ref{sec:requirement}.
...
The measured parameters for both ends are summarized in Tab.~\ref{tab:summary}. 
...
The left end of the bar has similar results, see Tab.~\ref{tab:summary}.
