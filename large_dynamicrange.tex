...
Based on the previous discussion, a voltage divider circuit is designed to extract current pulses from both dynode5 and dynode8, as shown in Fig.\ref{fig:divider}.
